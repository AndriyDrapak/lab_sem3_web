    ...
    <Router>
      ...
      <main>
        <Routes>
          ...
          <Route path="/form" element={<MyForm />} /> {/* Новий маршрут для форми */}
          <Route path="/success" element={<SuccessPage />} /> {/* Новий маршрут для сторінки успіху */}
        </Routes>
      </main>
      <Footer />
      <ToastContainer /> {/* Розміщення ToastContainer */}
    </Router>
  );
}
